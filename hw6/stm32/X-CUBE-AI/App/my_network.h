/**
  ...
  ******************************************************************************
  */
#ifndef AI_MY_NETWORK_H
#define AI_MY_NETWORK_H

#include "my_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MY_NETWORK_MODEL_NAME          "my_network"
#define AI_MY_NETWORK_ORIGIN_MODEL_NAME   "mini_efficientnet"

/******************************************************************************/
#define AI_MY_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MY_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MY_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MY_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_MY_NETWORK_IN \
  ai_my_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MY_NETWORK_IN_SIZE { \
  AI_MY_NETWORK_IN_1_SIZE, \
}
#define AI_MY_NETWORK_IN_SIZE_BYTES { \
  AI_MY_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_MY_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MY_NETWORK_IN_1_HEIGHT      (32)
#define AI_MY_NETWORK_IN_1_WIDTH       (32)
#define AI_MY_NETWORK_IN_1_CHANNEL     (3)
#define AI_MY_NETWORK_IN_1_SIZE        (3072)
#define AI_MY_NETWORK_IN_1_SIZE_BYTES  (12288)

/******************************************************************************/
#define AI_MY_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MY_NETWORK_OUT \
  ai_my_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MY_NETWORK_OUT_SIZE { \
  AI_MY_NETWORK_OUT_1_SIZE, \
}
#define AI_MY_NETWORK_OUT_SIZE_BYTES { \
  AI_MY_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_MY_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MY_NETWORK_OUT_1_CHANNEL     (10)
#define AI_MY_NETWORK_OUT_1_SIZE        (10)
#define AI_MY_NETWORK_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_MY_NETWORK_N_NODES (39)
 ...
 * @ref ai_my_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_my_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_my_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_my_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MY_NETWORK_*
 * defines into file @ref my_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_my_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MY_NETWORK_H */
